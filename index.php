...
<script src="https://use.fontawesome.com/f36c1900bb.js"></script>
...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.3.1/css/all.css" integrity="sha384-mzrmE5qonljUremFsqc01SB46JvROS7bZs3IO2EmfFsd15uHvIt+Y8vEf7N7fWAU" crossorigin="anonymous">
   ...
   <!--  <audio src="music.mp3" autoplay></audio> -->
      ...
      <aside id="about" class="sidebar sidebar-left">
         <div class="wrap">
            <div class="sidebar-control">
               <button class="btn btn-icon btn-primary btn-toggler" type="button" data-effect="push-right" data-target="#about">
            ...
            <div class="container">
               <header class="entry-header">
                  <h2 class="entry-title">ZeRo</h2>
               </header>
               <div class="entry-content">
                  <p class="fade-color-8">Basic Info:</p>
                  <p class="fade-color-4">
                  	Age: 15<br> Location: Hungary<br>Gender: Male<br><p class="fade-color-8">PC Specs:</p>
		  
                  <ul class="fade-color-4">
					<li>Intel Xeon Six-Core X5650 2.66GHz</li>
                    <li>Intel Xeon Six-Core X5650 2.66GHz</li>
					<li>ASUS GeForce GTX 1070 Ti 8GB GDDR5 256bit</li>
					<li>32GB HyperX Fury 2133MHz</li>
                    <li>SEAGATE 10TB 256MB</li>
                    <li>Asus VG248QE(144Hz)</li>
                    <li>SkullCandy Slyr</li>
                    <li>Razer BlackWidow Chroma V2</li>
					<li>Razer Goliathus</li>
                  </ul>
                  <br>
               </div>
            </div>
      ...
      <aside id="contact" class="sidebar sidebar-right">
         <div class="wrap">
            <div class="sidebar-control">
               <button class="btn btn-icon btn-primary btn-toggler" type="button" data-effect="push-left" data-target="#contact"><i class="fa fa-user" aria-hidden="true"></i></button>
            ...
            <div class="container">
               ...
               <div class="entry-content">
                  <p class="fade-color-8">Links:</p>
                  <div class="row fade-color-4">
                     <div class="col-30">
                        <p>
                           <a class="link-animated" href="https://rpatrik.github.io/">Main Page</a>
                            <br>
                           <a class="link-animated" href="http://steamcommunity.com/id/____________ZeRo1337____________">Steam</a>
                           <br><i id="not-allowed" class="link-animated">Forum (not yet)</i>
                              <br>             
                            <a class="link-animated" href="./login.php" method="get" target="_blank">Log In</a><br>
                            <a class="link-animated" href="./register.php" target="_blank">Register</a>
             ...
             <style>
	  		...
	  		<div id="phl" style="position: fixed; width: 100%; height: 100%; opacity: 1; z-index: -1;">
			<iframe frameborder="0" height="100%" width="100%" style="opacity: 0.01; pointer-events:none; transform: scale(1); " src="https://www.youtube.com/playlist?list=PLcCoil-3RBrzV8Nn19Qps3SWlCkmrimG2&autoplay=1&loop=1" frameborder="0" allowfullscreen></iframe>
		</div>
      ...
      <script src="concat.min.js"></script>
